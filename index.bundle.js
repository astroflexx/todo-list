...
`, "",{"version":3,"sources":["webpack://./src/style.css"],"names":[],"mappings":"AAAA;IACI,UAAU;IACV,SAAS;IACT,sBAAsB;AAC1B;;AAEA;IACI,aAAa;IACb,4BAA4B;AAChC;;AAEA;IACI,kBAAkB;AACtB;;AAEA;IACI,YAAY;IACZ,WAAW;IACX,aAAa;IACb,8BAA8B;AAClC;;AAEA;IACI,aAAa;IACb,sBAAsB;IACtB,2BAA2B;IAC3B,SAAS;AACb;;AAEA;IACI,YAAY;IACZ,UAAU;IACV,cAAc;;IAEd,aAAa;IACb,uBAAuB;IACvB,mBAAmB;IACnB,8BAA8B;IAC9B,uBAAuB;AAC3B;;AAEA;IACI,aAAa;IACb,uBAAuB;AAC3B;;AAEA;IACI,YAAY;IACZ,UAAU;IACV,aAAa;IACb,uBAAuB;IACvB,mBAAmB;AACvB;;AAEA;IACI,YAAY;IACZ,WAAW;IACX,YAAY;IACZ,uBAAuB;;IAEvB,aAAa;IACb,sBAAsB;IACtB,8BAA8B;AAClC;;AAEA;IACI,kBAAkB;AACtB;;AAEA;IACI,gBAAgB;AACpB;;AAEA;IACI,aAAa;IACb,mBAAmB;IACnB,2BAA2B;IAC3B,SAAS;IACT,gBAAgB;AACpB;;AAEA;IACI,YAAY;IACZ,aAAa;IACb,mBAAmB;AACvB;;AAEA;IACI,YAAY;IACZ,WAAW;AACf","sourcesContent":["* {\n    padding: 0;\n    margin: 0;\n    box-sizing: border-box;\n}\n\nbody {\n    height: 100vh;\n    background-color: lightgreen;\n}\n\nh1 {\n    text-align: center;\n}\n\n.todo-list {\n    height: 100%;\n    width: 100%;\n    display: grid;\n    grid-template-columns: 1fr 3fr;\n}\n\n.projects {\n    display: flex;\n    flex-direction: column;\n    justify-content: flex-start;\n    gap: 20px;\n}\n\n.project {\n    height: 5rem;\n    width: 90%;\n    margin: 0.5rem;\n\n    display: flex;\n    justify-content: center;\n    align-items: center;\n    background-color: lightskyblue;\n    border: 1px solid black;\n}\n\n.btn {\n    display: flex;\n    justify-content: center;\n}\n\n.create-new-project {\n    height: 50px;\n    width: 40%;\n    display: flex;\n    justify-content: center;\n    align-items: center;\n}\n\n.todo {\n    height: auto;\n    margin: 5px;\n    padding: 5px;\n    border: 2px solid black;\n\n    display: flex;\n    flex-direction: column;\n    justify-content: space-between;\n}\n\n.title {\n    font-size: x-large;\n}\n\n.description {\n    margin-top: 1rem;\n}\n\n.buttons {\n    display: flex;\n    flex-direction: row;\n    justify-content: flex-start;\n    gap: 20px;\n    margin-top: 1rem;\n}\n\n.due-date, .days-left {\n    height: auto;\n    display: flex;\n    align-items: center;\n}\n\nbutton {\n    height: 2rem;\n    width: 8rem;\n}\n"],"sourceRoot":""}]);
// Exports
...
/* harmony import */ var _maximize__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./maximize */ "./src/maximize.js");
/* harmony import */ var _minimize__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./minimize */ "./src/minimize.js");
...
function addNewTodo(todo, id) {
    ...
    const dropdown = (0,_createDropDown__WEBPACK_IMPORTED_MODULE_0__["default"])();
    ...
    duedate.textContent = `Due date: ${(0,date_fns__WEBPACK_IMPORTED_MODULE_3__.format)(todo.dueDate, 'PPPP')}`;
    ...
    minmax.addEventListener('click', (e) => {
        if (minmax.classList.contains('maximized')) {
            (0,_minimize__WEBPACK_IMPORTED_MODULE_2__["default"])(e);
        } else {
            (0,_maximize__WEBPACK_IMPORTED_MODULE_1__["default"])(e);
        }
    });
...
/* harmony export */   "default": () => (__WEBPACK_DEFAULT_EXPORT__)
/* harmony export */ });
/* harmony import */ var _mark_complete__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./mark_complete */ "./src/mark_complete.js");
/* harmony import */ var _maximize__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./maximize */ "./src/maximize.js");
/* harmony import */ var _minimize__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./minimize */ "./src/minimize.js");
...
function loadTodos(todos) {
    ...
    todos.forEach((todo) => {
        ...
        markcomplete.addEventListener('click', (todo) => {
            (0,_mark_complete__WEBPACK_IMPORTED_MODULE_0__["default"])(todo); 
        });
...
function markComplete(todo) {
    if (todo.complete) {
        todo.complete = false;
        element.textContent = 'Mark Complete';
    } else {
        todo.complete = true;
...
function handleMaximize(e) {
    ...
    box.insertBefore(dropdown, box.children[1]);
    box.insertBefore(daysLeft, box.children[1]);
}

/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = (handleMaximize);
    ...
    todo.childNodes.forEach((child) => {
        if (child.nodeType === Node.ELEMENT_NODE) {
            if (child.classList.contains('title')) {
                title = child;
            } else if (!(child.classList.contains('buttons'))) {
    ...
    box.childNodes.forEach((child) => {
        if (child.nodeType === Node.ELEMENT_NODE) {
            ...
            if (child.classList.contains('due-date')) {
                dueDate = child;
            } else if (!(child.classList.contains('minmax') || child.classList.contains('delete-btn'))) {
...
/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = (handleMinimize);
...
__webpack_require__.r(__webpack_exports__);
/* harmony import */ var _loadTodos__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./loadTodos */ "./src/loadTodos.js");
/* harmony import */ var _createNewTodo__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./createNewTodo */ "./src/createNewTodo.js");
/* harmony import */ var date_fns__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! date-fns */ "./node_modules/date-fns/differenceInCalendarDays.mjs");
/* harmony import */ var _addNewTodo__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./addNewTodo */ "./src/addNewTodo.js");
...
let data = JSON.parse(localStorage.getItem('data'));
let projectId = document.querySelector('.todos').id;

(0,_loadTodos__WEBPACK_IMPORTED_MODULE_0__["default"])(data[projectId].todos);
...
createTodo.addEventListener('click', () => {
    ...
    todos.removeChild(todobtndiv);
    (0,_createNewTodo__WEBPACK_IMPORTED_MODULE_1__["default"])();
    ...
    document.querySelector('.enter').addEventListener('click', () => {
        ...
        let daysLeft = (0,date_fns__WEBPACK_IMPORTED_MODULE_3__.differenceInCalendarDays)(dueDate, currDate);
        let complete = false;
        ...
        data[projectId].todos.push(todo);

        localStorage.setItem('data', JSON.stringify(data));

        (0,_addNewTodo__WEBPACK_IMPORTED_MODULE_2__["default"])(todo, data[projectId].todos.length - 1);

        todos.appendChild(todobtndiv);
    });
});
